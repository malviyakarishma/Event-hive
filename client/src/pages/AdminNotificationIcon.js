...
import { io } from 'socket.io-client'; // Ensure you have this import for socket.io
  ...
  useEffect(() => {
    ...
    socket.on('admin-notification', (notification) => {
      setAdminNotifications(prev => {
        // Prevent duplicate notifications from being added to the state
              ...
              <ul>
                {adminNotifications.map((notification) => (
                  <li 
                    ...
                    className={`px-4 py-3 border-b hover:bg-gray-50 ${notification.isRead ? 'bg-white' : 'bg-purple-50'}`}
